...
#define SLIC3R_APP_FULL_NAME "PollenAMOrcaSlicer"
#define GCODEVIEWER_APP_NAME "PollenAMOrcaSlicer G-code Viewer"
#define GCODEVIEWER_APP_KEY  "OrcaSlicerGcodeViewer"
#define GCODEVIEWER_BUILD_ID std::string("PollenAMOrcaSlicer G-code Viewer-") + std::string(SLIC3R_VERSION) + std::string("-RC")
