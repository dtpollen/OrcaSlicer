    ...
    : paddingSize(10, 8)
{
    background_color = StateColor(
        ...
        std::make_pair(0xF6A800, (int) StateColor::Checked),
...
wxString btn_regular[10]  = {"#DFDFDF", "#DFDFDF", "#D4D4D4", "#DFDFDF", "#DFDFDF", "#6B6A6A", "#262E30", "#262E30", "#F6A800", "#F6A800"};
wxString btn_confirm[10]  = {"#DFDFDF", "#F6A800", "#FFB300", "#F6A800", "#F6A800", "#6B6A6A", "#FEFEFE", "#FEFEFE", "#FFCB05", "#FFC107"};
wxString btn_alert[10]    = {"#DFDFDF", "#DFDFDF", "#E14747", "#DFDFDF", "#DFDFDF", "#6B6A6A", "#262E30", "#FFFFFD", "#F6A800", "#F6A800"};
