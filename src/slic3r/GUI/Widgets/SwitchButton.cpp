...
SwitchButton::SwitchButton(wxWindow* parent, wxWindowID id)
    ...
    , thumb_color(std::pair{0xF6A800, (int) StateColor::Checked}, std::pair{0xD9D9D9, (int) StateColor::Normal})
{
...
ModeSwitchButton::ModeSwitchButton(wxWindow* parent, wxWindowID id)
{
    ...
    border_color = StateColor(
        ...
        std::make_pair(wxColour("#FFB300"), (int) StateColor::Focused),
        std::make_pair(wxColour("#D9D9D9"), (int) StateColor::Normal)
    );
    track_background = StateColor(
        std::make_pair(wxColour("#F6A800"), (int) StateColor::Disabled),
        std::make_pair(wxColour("#F6A800"), (int) StateColor::Normal)
    );
    track_border = StateColor(
        std::make_pair(wxColour("#D9D9D9"), (int) StateColor::Disabled),
        std::make_pair(wxColour("#F6A800"), (int) StateColor::Hovered | ~StateColor::Focused),
        std::make_pair(wxColour("#FFB300"), (int) StateColor::Focused),
        std::make_pair(wxColour("#F6A800"), (int) StateColor::Normal)
    );
...
void SwitchBoard::doRender(wxDC &dc)
{
	...
	/*left*/
    if (switch_left) {
        is_enable ? dc.SetBrush(wxBrush(wxColour(246, 168, 0))) : dc.SetBrush(disable_color);
	...
	/*right*/
    if (switch_right) {
        if (is_enable) {dc.SetBrush(wxBrush(wxColour(246, 168, 0)));
        } else {dc.SetBrush(disable_color);}
...
MultiSwitchButton::MultiSwitchButton(wxWindow *parent, wxWindowID id, const wxPoint &pos, const wxSize &size, long style)
    ...
    , m_bg_color(StateColor(
          ...
          std::make_pair(0xF6A800, (int) StateColor::Normal)))
