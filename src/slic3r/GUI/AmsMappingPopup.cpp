...
void AmsReplaceMaterialDialog::create()
{
    ...
    identical_filament->SetForegroundColour(StateColor::darkModeColorFor(wxColour("#F6A800")));
    ...
    StateColor btn_bg_green(std::pair<wxColour, int>(wxColour(255, 179, 0), StateColor::Pressed), std::pair<wxColour, int>(wxColour(246, 168, 0), StateColor::Normal));
